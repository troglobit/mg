...
/*
 * Character width, after Markus Kuhn's wcwidth.c.  A codepoint takes no
 * column of its own when it combines with the one before it, two when
 ...
 * of the CJK planes.  Kuhn's own tables stop at Unicode 5.0, before the
 * emoji were given a width.
 *
...
{
	static const struct interval zerowidth[] = {
	...
	static const struct interval wide[] = {
		...
		{ 0x1F6D0, 0x1F6D2 }, { 0x1F6D5, 0x1F6D8 }, { 0x1F6DC, 0x1F6DF },
		{ 0x1F6EB, 0x1F6EC }, { 0x1F6F4, 0x1F6FC }, { 0x1F7E0, 0x1F7EB },
		{ 0x1F7F0, 0x1F7F0 }, { 0x1F90C, 0x1F93A }, { 0x1F93C, 0x1F945 },
		{ 0x1F947, 0x1F9FF }, { 0x1FA70, 0x1FA7C }, { 0x1FA80, 0x1FA8A },
		{ 0x1FA8E, 0x1FAC6 }, { 0x1FAC8, 0x1FAC8 }, { 0x1FACD, 0x1FADC },
		{ 0x1FADF, 0x1FAEA }, { 0x1FAEF, 0x1FAF8 }, { 0x20000, 0x2FFFD },
		{ 0x30000, 0x3FFFD }
	};
	...
	if (ucs < 32 || (ucs >= 0x7f && ucs < 0xa0))
		return (-1);
	if (bisearch(ucs, zerowidth,
	    sizeof(zerowidth) / sizeof(zerowidth[0]) - 1))
		return (0);
