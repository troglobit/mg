...
static struct funmap functnames[] = {
	...
	{selfinsert, "self-insert-command", 1},
...
#ifdef TOGGLENL
	{togglenewlineprompt, "toggle-newline-prompt", 0},
#endif /* TOGGLENL */
